  ...
  contactInfo() {
    ...
    return (
      <div className="ListingShowContact">
        Check out this apartment on: {address.street}, {address.subNeighborhood}.
        Please contact the agent by texting or calling the following number:{" "}
        {agent.phone}, or email the agent directly:{" "}
      ...
      return (
        <div className="ListingShowContainer">
          ...
          <div className="ListingShowUserLink">
            <Link to={baseUrl + "/UserListings/" + authorKey}>
              {" "}
